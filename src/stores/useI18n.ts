...
const traducciones: Traducciones = {
  es: {
    ...
    consejo_condicion_descripcion: "El impacto positivo de una nutrición adecuada está bien establecido en todos los animales. Una alimentación adaptada a la edad y necesidades nutricionales de cada gato, mejora su calidad de vida.",
    ...
    consejo_comportamiento_titulo: "Entendiendo el comportamiento felino",
    consejo_comportamiento_descripcion: "Interpreta el lenguaje corporal de tu gato y aprende a reconocer sus necesidades. Consejos para una mejor comunicación con tu mascota.",
    consejo_salud_titulo: "Cuidados veterinarios esenciales",
    consejo_salud_descripcion: "Calendario de vacunación, desparasitación y revisiones veterinarias. Aprende a detectar señales de alerta en la salud de tu gato.",
    consejo_juegos_titulo: "Juegos y ejercicios",
    consejo_juegos_descripcion: "Ideas para mantener a tu gato activo y entretenido. Descubre juguetes seguros y actividades que estimularán física y mentalmente a tu felino.",
    consejo_convivencia_titulo: "Convivencia con otros animales",
    consejo_convivencia_descripcion: "Consejos prácticos para introducir un nuevo gato en un hogar con otras mascotas. Aprende a gestionar la convivencia de manera armoniosa.",
  },
  en: {
    // Home
    ...
    consejo_condicion_descripcion: "The positive impact of proper nutrition is well established in all animals. A diet adapted to each cat's age and nutritional needs improves their quality of life.",
    ...
    consejo_comportamiento_titulo: "Understanding Feline Behavior",
    consejo_comportamiento_descripcion: "Interpret your cat's body language and learn to recognize their needs. Tips for better communication with your pet.",
    consejo_salud_titulo: "Essential Veterinary Care",
    consejo_salud_descripcion: "Vaccination schedule, deworming, and veterinary check-ups. Learn to detect warning signs in your cat's health.",
    consejo_juegos_titulo: "Games and Exercises",
    consejo_juegos_descripcion: "Ideas to keep your cat active and entertained. Discover safe toys and activities that will stimulate your feline physically and mentally.",
    consejo_convivencia_titulo: "Living with Other Animals",
    consejo_convivencia_descripcion: "Practical advice for introducing a new cat into a home with other pets. Learn to manage harmonious coexistence.",
  }
}
